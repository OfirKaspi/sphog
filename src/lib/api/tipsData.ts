const getTipsData = () => {
  const data = {
    header: {
      ...
      description: "כאן תמצאו מדריכים קצרים, סרטונים וטיפים שעושים סדר ועוזרים לכם לבנות ולעצב טרריום בבית וגם איך הכי טוב לשמור על הטרריום שלכם מה לשתול, איך לטפל, ומה עושים כשמשהו לא עובד.",
    },
    videoTip: {
