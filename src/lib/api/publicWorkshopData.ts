    ...
    const data = {
        ...
        workshopItems: [
            ...
            },
            {
                ...
                paragraphs: [
                    "הסדנאות מיועדות למי שרוצה להעמיק בטכניקות העיצוב של הטרריום ולקחת את היצירה שלו לרמה הבאה. בסדנא נלמד בנייה של טכניקות מורכבות כמו עמוד אבנים פראי או קשת שמהם משתרגת צמחייה שופעת, מצוקים ועוד.",
        ...
        testimonials: {
            ...
            testimonials: [
                ...
                {
                    name: "אלון",
                    quote: "היינו כל המשפחה בסדנא אצל אייל. היתה סדנא נהדרת, כייפית ומעניינת שהתאימה לכולנו גם לאמא שלי בת ה 70 וגם לבנותי הסטודנטיות. אווירה טובה ואייל משקיע ועוזר לכל משתתף. יצאנו כל אחד עם יצירה נהדרת. ממליץ מאוד!",
                    role: "הגיע עם אמא שלו ובנותיו לסדנא קבוצתית",
                    image: {
                        src: "https://res.cloudinary.com/dudwjf2pu/image/upload/v1747765974/sphog/1_kawtgf.png",
                        alt: "אלון",
                    },
