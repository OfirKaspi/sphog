...
const SocialMedia = () => {
  ...
  return (
    <div className="flex w-full flex-col items-center justify-center gap-2 rounded-md border-2 border-secondary p-5 md:mx-auto md:w-fit md:flex-row lg:ml-0 lg:mr-auto lg:p-2">
